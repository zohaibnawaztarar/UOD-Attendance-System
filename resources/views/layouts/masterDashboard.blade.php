...
<head>
    ...
    <link href="https://cdn.datatables.net/buttons/1.6.1/css/buttons.dataTables.min.css" rel="stylesheet" crossorigin="anonymous" />
    ...
    {{-- JS Libaries required for Data Tables--}}
...
<nav class="sb-topnav navbar navbar-expand-lg navbar-dark fixed-top" id="mainn=Nav" style="background-color: #4365e2;">
    ...
    <a class="navbar-brand" href="{{ route('dashboard') }}" class="header__logo header__icon" aria-label="university of dundee logo and link to home page">
                ...
                <div class="nav">
                    ...
                    @if(Auth::user()->isLecturer())
                        ...
                        ><div class="sb-nav-link-icon"><i class="fas fa-user-plus"></i></div>
                            Student Enrolment
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                        <div class="collapse" id="collapseEnrol" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                    ...
                    @elseif (Auth::user()->isStudent())
                        ...
                        <div class="collapse" id="collapseReports" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="{{ route('myReports', ['stu_id' => Auth::user()->id]) }}">My Attendance Report</a>
                            </nav>
